...
const dict = {
  nl: {
    ...
    // ── revision history (§8) ───────────────────────────────────────────────
    "versions.section": "Eerdere versies",
    "versions.hint":
      "De laatste {count} opgeslagen versies, alleen op dit apparaat. Ze worden niet gesynchroniseerd.",
    "versions.changed": "Gewijzigd: {fields}",
    "versions.identical": "Gelijk aan nu",
    "versions.restore": "Terugzetten",
    "versions.restore.confirm": "Versie van {when} terugzetten? Dit overschrijft: {fields}.",
    "versions.restored": "Versie teruggezet",
    "versions.field.title": "titel",
    "versions.field.type": "soort",
    "versions.field.body": "inhoud",
    "versions.field.comment": "notitie",
    "versions.field.tags": "labels",
    "versions.field.pinned": "vastgezet",
    "versions.field.reminderAt": "herinnering",
    "versions.field.reminderType": "soort herinnering",
    "versions.field.recurrence": "herhaling",
    "versions.field.occurredAt": "datum",
    "versions.field.eventType": "soort gebeurtenis",
    "versions.field.amount": "bedrag",
    "versions.field.fields": "gegevens",
    "versions.field.links": "links",
    "versions.field.attachments": "bestanden",
    "versions.field.linkedIds": "gekoppelde items",
    ...
    "views.title": "Bewaarde weergaven",
    "views.save": "Weergave bewaren",
    "views.save.prompt": "Hoe wil je deze weergave noemen?",
    "views.saved": "\u201e{name}\u201d bewaard",
    "views.remove": "\u201e{name}\u201d verwijderen",
    "views.nothingToSave": "Stel eerst een filter in.",
    "views.full": "Je kunt maximaal {max} weergaven bewaren.",
    "bulk.select": "Meerdere selecteren",
    "bulk.count": "{count} geselecteerd",
    "bulk.done": "Klaar",
    "bulk.tag": "Label",
    "bulk.tag.prompt": "Welk label wil je toevoegen?",
    "bulk.tag.done": "\u201e{tag}\u201d toegevoegd aan {count} items",
    "bulk.type": "Soort wijzigen",
    "bulk.type.done": "{count} items zijn nu {type}",
    ...
    "field.fields.key": "Naam",
    "field.fields.value": "Waarde",
    "field.fields.remove": "Gegeven verwijderen",
    "action.copy": "Kopi\u00ebren",
    "action.copy.failed": "Kopi\u00ebren lukt niet in deze browser.",
    "fields.suggest.provider": "Leverancier",
    "fields.suggest.customerNumber": "Klantnummer",
    "fields.suggest.username": "Gebruikersnaam",
    "fields.suggest.reference": "Referentie",
    "fields.suggest.contractNumber": "Contractnummer",
    "fields.suggest.meterNumber": "Meternummer",
    "fields.suggest.renewal": "Verlengdatum",
    "fields.suggest.brand": "Merk",
    "fields.suggest.model": "Model",
    "fields.suggest.serial": "Serienummer",
    "fields.suggest.installer": "Installateur",
    "fields.suggest.warrantyUntil": "Garantie tot",
    "fields.suggest.address": "Adres",
    "fields.suggest.location": "Locatie",
    "fields.suggest.issuer": "Uitgegeven door",
    "fields.suggest.validUntil": "Geldig tot",
    "fields.suggest.contact": "Contactpersoon",
    "fields.suggest.phone": "Telefoon",
    "panel.empty": "leeg",
  ...
  en: {
    ...
    // ── revision history (§8) ───────────────────────────────────────────────
    "versions.section": "Earlier versions",
    "versions.hint": "The last {count} saves, on this device only. They are never synced.",
    "versions.changed": "Changed: {fields}",
    "versions.identical": "Same as now",
    "versions.restore": "Restore",
    "versions.restore.confirm": "Restore the version from {when}? This overwrites: {fields}.",
    "versions.restored": "Version restored",
    "versions.field.title": "title",
    "versions.field.type": "type",
    "versions.field.body": "content",
    "versions.field.comment": "note",
    "versions.field.tags": "tags",
    "versions.field.pinned": "pinned",
    "versions.field.reminderAt": "reminder",
    "versions.field.reminderType": "reminder type",
    "versions.field.recurrence": "repeat",
    "versions.field.occurredAt": "date",
    "versions.field.eventType": "event type",
    "versions.field.amount": "amount",
    "versions.field.fields": "details",
    "versions.field.links": "links",
    "versions.field.attachments": "files",
    "versions.field.linkedIds": "linked items",
    ...
    "views.save.prompt": "What do you want to call this view?",
    "views.saved": "Saved \u201c{name}\u201d",
    "views.remove": "Remove \u201c{name}\u201d",
    "views.nothingToSave": "Set a filter first.",
    "views.full": "You can keep at most {max} views.",
    "bulk.select": "Select several",
    "bulk.count": "{count} selected",
    "bulk.done": "Done",
    "bulk.tag": "Tag",
    "bulk.tag.prompt": "Which tag do you want to add?",
    "bulk.tag.done": "Added \u201c{tag}\u201d to {count} records",
    "bulk.type": "Change type",
    "bulk.type.done": "{count} records are now {type}",
    "bulk.export": "Export",
    ...
    "field.fields.remove": "Remove this detail",
    "action.copy": "Copy",
    "action.copy.failed": "This browser will not copy to the clipboard.",
    "fields.suggest.provider": "Provider",
    "fields.suggest.customerNumber": "Customer number",
    "fields.suggest.username": "Username",
    "fields.suggest.reference": "Reference",
    "fields.suggest.contractNumber": "Contract number",
    "fields.suggest.meterNumber": "Meter number",
    "fields.suggest.renewal": "Renewal date",
    "fields.suggest.brand": "Brand",
    "fields.suggest.model": "Model",
    "fields.suggest.serial": "Serial number",
    "fields.suggest.installer": "Installer",
    "fields.suggest.warrantyUntil": "Warranty until",
    "fields.suggest.address": "Address",
    "fields.suggest.location": "Location",
    "fields.suggest.issuer": "Issued by",
    "fields.suggest.validUntil": "Valid until",
    "fields.suggest.contact": "Contact",
    "fields.suggest.phone": "Phone",
    "panel.empty": "empty",
